// Service Worker do app "Estoque de Caixas".
...
// Troque o valor de CACHE_VERSION abaixo (ex: 'v1' -> 'v2') toda vez
// que publicar uma mudança no app. Isso é o que faz o navegador perceber
